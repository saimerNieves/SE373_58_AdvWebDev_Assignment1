...
// function requestListenerFunction(userRequest, serverResponse){

//     let pathname = userRequest.pathname;
...
//         fileSystemLibrary.readFile("todo.json", callBackFunctionAfterAccessFile)

//         function callBackFunctionAfterAccessFile(errorsFound, dataInsideFileAccessed){

//             if(errorsFound){

//                 console.log("ERRORS")
//                 serverResponse.writeHead(400, {"Content-type": "text/html"})
//                 serverResponse.write(`<!DOCTYPE><html><body><div> PAGE NOT FOUND Here </div></body></html></!DOCTYPE>`)
//             }
//             else{
...
//         console.log("ERRORS AT: " + pathname)
//                 serverResponse.writeHead(400, {"Content-type": "text/html"})
//                 serverResponse.write(`<!DOCTYPE><html><body><div> PAGE NOT FOUND now ${pathname}</div></body></html></!DOCTYPE>`)
